...
public class JsonTest03OkController extends HttpServlet
{
	...
	protected void doGetPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("WEB-INF/view/JsonTest03_ok.jsp");
		//RequestDispatcher dispatcher = request.getRequestDispatcher("JsonTest03_ok.jsp");
