...
<script type="text/javascript">
	...
	function callBack2()
	{
		...
		var itemList = root.getElementsByTagName("item");		//getElements = 배열을 반환 받음
	...
	function change()
	{
		...
		var addre1 = str.substring(0, 5);
		var addre2 = str.substring(6);
		
		document.getElementById("addr1").value = addre1;
		document.getElementById("addr2").value = addre2;
...
<table class="table">
	...
	<tr>
		...
		<td>
			...
			<br>
			<select id="addrResult" class="control" onchange="selectZipCode(this)"> <!-- onchange="change()" -->
