...
<%!
	//○ 선언부 영역 → 함수 정의가 가능한 영역(클래스 안에서의 역할)
...
%>
<%
	//○ 스크립 릿 영역(함수 정의 불가함 -> 메소드 안에서의 역할)
...
<!-- 
	※ 요청한 페이지(jsptest003.jsp)의 결과를 확인한 후 새로고침을 반복해보면...
	   ...
	   ==> 변수 a는 클래스(jsptest003_jsp) 의 전역변수로 선언된 것을 확인할 수 있다.
	       이는 객체가 소멸되기 전까지는 계속 값이 유지된다는 것을 의미한다.
	       변수 a 는 메소드(jsptest003_jsp 클래스의 _jspService() 메소드) 내의
